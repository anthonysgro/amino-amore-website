...
function DNAHeart({ className }: DNAHeartProps) {
  ...
  useEffect(() => {
    ...
    const numPoints = 100
    const helixRadius = 2.2 // Wider spiral
    ...
    // Create continuous tube for strand 1
    ...
    // Create continuous tube for strand 2
    ...
    // Add base pair rungs connecting the two strands
