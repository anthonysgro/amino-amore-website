  ...
  return (
    <div className={cn('space-y-3', className)}>
      <div className="text-center">
        <h3 className="text-sm font-medium text-pink-700">Choose Your Bond Type</h3>
        <p className="text-xs text-pink-500">Each creates a unique protein shape</p>
      </div>
          ...
          return (
            <button
              ...
              className={cn(
                ...
                // Selected state
                isSelected
                  ? 'border-pink-400 bg-pink-100/80 shadow-lg shadow-pink-200/50'
                  : 'border-pink-200/50 bg-white/60 hover:border-pink-300 hover:bg-pink-50/80 hover:shadow-md',
            ...
            >
              ...
              <span
                className={cn(
                  ...
                  isSelected ? 'text-pink-700' : 'text-pink-600'
                )}
              >
                {config.displayName}
              </span>
              ...
              {/* Description */}
              <span className="text-xs text-pink-500/80 leading-tight">
                {config.description}
              </span>
            </button>
          )
