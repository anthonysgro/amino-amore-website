    ...
    handlers: {
      GET: async ({ params }) => {
        ...
        if (cloudName) {
          ...
          // Scale up 1.4x then crop to 1200x630 centered (creates zoom effect)
          const cloudinaryUrl = `https://res.cloudinary.com/${cloudName}/image/upload/c_scale,w_1680/c_crop,w_1200,h_630,g_center/${publicId}.png`
